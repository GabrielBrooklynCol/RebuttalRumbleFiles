...
# var a = 2
# var b = "text"
var dialog = ["She wouldn't even THINK of giving em the littlest of puppy dog love! Better watch that tone... you soundin like yer conspirin with em. "]
