...
# var a = 2
# var b = "text"
var dialog = ["They wouldn’t know what family is if it were conditioned into em! I gave them everything, house, security, a romantic saloon, and they had the gall to go after my female! Just hear what they try to do to her!"]
	...
	if event is InputEventMouseButton and event.pressed:
		if get_visible_characters() > get_total_character_count():
			...
			if page+1 > dialog.size()-1: #The very last dialog will be filler that's intended to be skipped over. Once it's skipped, the dialog box will be closed
				...
				$ResponseFamilyBTN.visible = true
				#page = -2
