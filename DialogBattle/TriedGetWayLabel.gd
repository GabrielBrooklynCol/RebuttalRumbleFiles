...
# var a = 2
# var b = "text"
var dialog = ["Oh, where do I even start? It's easier telling you the first time I drank my happy and sleepy juice, or as we call it, booze. Nah, I need to address their audacities proper"]
