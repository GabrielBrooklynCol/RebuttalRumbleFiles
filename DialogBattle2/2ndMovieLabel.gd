...
# var a = 2
# var b = "text"
var dialog = ["No, I didn't. My heart's reserved for Cat's and Cat's alone. They just wanna force themselves between us and break it. It's soundin like yer tryna break that, too..."]
